  ...
  <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
    ...
    <div class="mx-auto max-w-5xl">
        ...
        <form action="#" class="w-full rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6 lg:max-w-xl lg:p-8">
          <div class="mb-6 grid grid-cols-2 gap-4">
            <div class="col-span-2 sm:col-span-1">
              <label for="full_name" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white"> {!! __("Full name (as displayed on card)*") !!} </label>
            ...
            <div>
              <label for="cvv-input" class="mb-2 flex items-center gap-1 text-sm font-medium text-gray-900 dark:text-white">
                ...
                <div id="cvv-desc" role="tooltip" class="tooltip invisible absolute z-10 inline-block rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-sm transition-opacity duration-300 dark:bg-gray-700">
                  {!! __("The last 3 digits on back of card") !!}
          ...
          <button type="submit" class="flex w-full items-center justify-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4  focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">{!! __("Pay now") !!}</button>
        </form>
          ...
          <div class="space-y-4 rounded-lg border border-gray-100 bg-gray-50 p-6 dark:border-gray-700 dark:bg-gray-800">
            <div class="space-y-2">
              <dl class="flex items-center justify-between gap-4">
                ...
                <dd class="text-base font-medium text-gray-900 dark:text-white">{{ __('$') }}{{ $plan->price }}</dd>
              </dl>
            </div>

            <dl class="flex items-center justify-between gap-4 border-t border-gray-200 pt-2 dark:border-gray-700">
              <dt class="text-base font-bold text-gray-900 dark:text-white">{!! __("Total") !!}</dt>
              <dd class="text-base font-bold text-gray-900 dark:text-white">{{ __('$') }}{{ $plan->price }}</dd>
            </dl>
          </div>
      ...
      <p class="mt-6 text-center text-gray-500 dark:text-gray-400 sm:mt-8">
        {!! __("Payment processed by <a href='#' title='' class='font-medium text-primary-700 underline hover:no-underline dark:text-primary-500'>Stripe</a> for <a href='#' title='' class='font-medium text-primary-700 underline hover:no-underline dark:text-primary-500'>AI Concierge</a> - Japan") !!}
      </p>
    </div>
  </div>
</section>
